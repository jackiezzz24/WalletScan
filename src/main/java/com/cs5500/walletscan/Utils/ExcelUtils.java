...
import static com.cs5500.walletscan.Utils.FileFactory.PATH_TEMPLATE;

@Slf4j
@Component
public class ExcelUtils {
        //export config
        public static ByteArrayInputStream exportCustomer(List<Transaction> transactions, String fileName) throws Exception {
            ...
            processInsertData(xssfWorkbook, transactions);
        ...
        public static List<File> getFilesExcelStoreDataFromDatabase(List<Transaction> transactions, String fileName) throws Exception {
            ...
            processInsertData(workbook, transactions);
        ...
        private static void processInsertData(XSSFWorkbook xssfWorkbook, List<Transaction> transactions){
            ...
            insertDataToWorkbook(xssfWorkbook, ExportConfig.customerExport, transactions, dataCellStyle);
            //return
        }
